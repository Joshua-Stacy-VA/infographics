...
IFG.displayPie = function(options) {
	...
	var json = options.json || "json/PIKSCount.json";
	...
	d3.json(json, function(error, data) {
	  ...
	  g.append("path")
		  .attr("d", arc)
		  .style("fill", function(d, i) {if(colorsByCategory) return color(d.data[categoryTitle]); 
		  								else {console.log(color(i)); return color(i);} })
